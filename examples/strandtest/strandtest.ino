...
/*Control RGB LED Modules in a strip
*****************************************************************************
Number of RGB LEDs in strand, unsure of this yet, will possibly only use one LED, per colour
*/
...
parameters are SPI data and clock pins (Synchronous Serial communication, either input or output, is heavily reliant on what is referred to as a clock pin):
*/
...
void setup() {
  ...
  clock_prescale_set(clock_div_1); // Enable 16 MHz
#endif
